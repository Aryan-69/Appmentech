...
(function () {
  ...
  window.ICONS = {
    ...
    crm: '<svg ' + S + '><path d="M3 7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M3 10h18"/><circle cx="8.5" cy="14" r="1.5"/><path d="M13 13h5M13 16h3"/></svg>',
    care: '<svg ' + S + '><path d="M12 3l8 3.5V11c0 5-3.4 8.5-8 10-4.6-1.5-8-5-8-10V6.5L12 3z"/><path d="M9.5 12.5h1.6l1 -2 1.4 4 1-2h1.5"/></svg>',
    sports: '<svg ' + S + '><path d="M8 3h8v5.5a4 4 0 0 1-8 0z"/><path d="M8 4.5H5.5a2.5 2.5 0 0 0 0 5H7"/><path d="M16 4.5h2.5a2.5 2.5 0 0 1 0 5H17"/><path d="M12 12.5V16"/><path d="M9 21h6l-.6-3.4a1 1 0 0 0-1-.8h-2.8a1 1 0 0 0-1 .8z"/></svg>',
    payments: '<svg ' + S + '><rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20"/><path d="M6 15h4"/></svg>',
    pos: '<svg ' + S + '><rect x="5" y="2" width="14" height="20" rx="2"/><path d="M8 6h8"/><path d="M8.5 11h.01M12 11h.01M15.5 11h.01M8.5 14.5h.01M12 14.5h.01M15.5 14.5h.01M8.5 18h.01M12 18h.01M15.5 18h.01"/></svg>',
    local: '<svg ' + S + '><path d="M3.2 9 5 4.6A1.5 1.5 0 0 1 6.4 3.7h11.2A1.5 1.5 0 0 1 19 4.6L20.8 9"/><path d="M3.2 9h17.6"/><path d="M5 9v11h14V9"/><path d="M9.5 20v-5.5h5V20"/></svg>',
