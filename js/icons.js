...
(function () {
  ...
  window.ICONS = {
    ...
    sports: '<svg ' + S + '><circle cx="12" cy="12" r="9"/><path d="M12 3c2.4 2.4 3.6 5.4 3.6 9S14.4 18.6 12 21c-2.4-2.4-3.6-5.4-3.6-9S9.6 5.4 12 3z"/><path d="M3.5 9.5c2.6 1.4 5.4 2 8.5 2s5.9-.6 8.5-2"/></svg>',
    ...
    local: '<svg ' + S + '><path d="M4 10.5 12 4l8 6.5"/><path d="M5.5 10v10h13V10"/><path d="M3 20h18"/><path d="M9.5 20v-4.5h5V20"/></svg>',
